...
public class Task2 {
    public static void main(String[] args) {
        ChessPiece[][] configuration = {{ChessPiece.ROOK_BLACK, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.ROOK_BLACK, ChessPiece.KING_BLACK, ChessPiece.EMPTY},
        ...
        ChessBoard chessBoard = new ChessBoard(configuration);
